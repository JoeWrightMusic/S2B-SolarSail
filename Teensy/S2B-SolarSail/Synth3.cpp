  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec1[0] = 1;
			iRec11[0] = (iVec1[1] + iRec11[1]) % 32768;
			table[i1] = std::sin(0.0001917476f * float(iRec11[0]));
			iVec1[1] = iVec1[0];
			iRec11[1] = iRec11[0];
		}
	}
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filters_lib_highpass6e_author", "Julius O. Smith III");
		m->declare("filters_lib_highpass6e_copyright", "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>");
		m->declare("filters_lib_highpass6e_license", "MIT-style STK-4.3 license");
		...
		m->declare("filters_lib_lowpass6e_author", "Julius O. Smith III");
		m->declare("filters_lib_lowpass6e_copyright", "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>");
		m->declare("filters_lib_lowpass6e_license", "MIT-style STK-4.3 license");
		...
		m->declare("library_path10", "/libraries/noises.lib");
		m->declare("library_path11", "/libraries/compressors.lib");
		...
		m->declare("library_path6", "/libraries/envelopes.lib");
		m->declare("library_path7", "/libraries/reverbs.lib");
		m->declare("library_path8", "/libraries/filters.lib");
		m->declare("library_path9", "/libraries/delays.lib");
		m->declare("maths_lib_author", "GRAME");
		m->declare("maths_lib_copyright", "GRAME");
		m->declare("maths_lib_license", "LGPL with exception");
		m->declare("maths_lib_name", "Faust Math Library");
		m->declare("maths_lib_version", "2.5");
		m->declare("name", "Synth3");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::exp(0.0f - 5e+01f / fConst0);
		float fConst3 = std::tan(314.15927f / fConst0);
		float fConst4 = mydsp_faustpower2_f(fConst3);
		float fConst5 = 1.0f / fConst4;
		fConst6 = 2.0f * (0.9351402f - fConst5);
		float fConst7 = 1.0f / fConst3;
		fConst8 = (fConst7 + -0.15748216f) / fConst3 + 0.9351402f;
		fConst9 = 1.0f / ((fConst7 + 0.15748216f) / fConst3 + 0.9351402f);
		fConst10 = 2.0f * (1.4500711f - fConst5);
		fConst11 = (fConst7 + -0.74313045f) / fConst3 + 1.4500711f;
		fConst12 = 1.0f / ((fConst7 + 0.74313045f) / fConst3 + 1.4500711f);
		fConst13 = 2.0f * (4.0767817f - fConst5);
		fConst14 = (fConst7 + -3.1897273f) / fConst3 + 4.0767817f;
		fConst15 = 1.0f / ((fConst7 + 3.1897273f) / fConst3 + 4.0767817f);
		fConst16 = 44.1f / fConst0;
		fConst17 = 1.0f - fConst16;
		fConst18 = 3.1415927f / fConst0;
		float fConst19 = 0.0017661728f / fConst4;
		fConst20 = fConst19 + 0.0004076782f;
		fConst21 = 2.0f * (0.0004076782f - fConst19);
		float fConst22 = 11.0520525f / fConst4;
		fConst23 = fConst22 + 1.4500711f;
		fConst24 = 2.0f * (1.4500711f - fConst22);
		float fConst25 = 50.06381f / fConst4;
		fConst26 = fConst25 + 0.9351402f;
		fConst27 = 2.0f * (0.9351402f - fConst25);
		fConst28 = 1.0f / fConst0;
		fConst29 = std::exp(0.0f - fConst28);
		fConst30 = 1.0f - fConst29;
		fConst31 = 0.0027777778f / fConst0;
		fConst32 = 1.0f / std::max<float>(1.0f, 0.001f * fConst0);
		iConst33 = int(0.036666665f * fConst0);
		iConst34 = int(0.035306122f * fConst0);
		iConst35 = int(0.033809524f * fConst0);
		iConst36 = int(0.0322449f * fConst0);
		iConst37 = int(0.030748298f * fConst0);
		iConst38 = int(0.028956916f * fConst0);
		iConst39 = int(0.026938776f * fConst0);
		iConst40 = int(0.025306122f * fConst0);
		iConst41 = std::min<int>(1024, std::max<int>(0, int(0.0126077095f * fConst0) + -1));
		iConst42 = std::min<int>(1024, std::max<int>(0, int(0.01f * fConst0) + -1));
		iConst43 = std::min<int>(1024, std::max<int>(0, int(0.0077324263f * fConst0) + -1));
		iConst44 = std::min<int>(1024, std::max<int>(0, int(0.0051020407f * fConst0) + -1));
		fConst45 = 1.0f - fConst2;
		fConst46 = 1.0f - fConst1;
		float fConst47 = std::tan(1884.9556f / fConst0);
		float fConst48 = mydsp_faustpower2_f(fConst47);
		float fConst49 = 1.0f / fConst48;
		fConst50 = 2.0f * (1.0693583f - fConst49);
		float fConst51 = 1.0f / fConst47;
		fConst52 = (fConst51 + -0.16840488f) / fConst47 + 1.0693583f;
		float fConst53 = (fConst51 + 0.16840488f) / fConst47 + 1.0693583f;
		fConst54 = 1.0f / fConst53;
		fConst55 = 2.0f * (0.6896214f - fConst49);
		fConst56 = (fConst51 + -0.51247865f) / fConst47 + 0.6896214f;
		fConst57 = 1.0f / ((fConst51 + 0.51247865f) / fConst47 + 0.6896214f);
		fConst58 = 2.0f * (0.2452915f - fConst49);
		fConst59 = (fConst51 + -0.78241307f) / fConst47 + 0.2452915f;
		fConst60 = 1.0f / ((fConst51 + 0.78241307f) / fConst47 + 0.2452915f);
		float fConst61 = 0.0001f / fConst48;
		fConst62 = fConst61 + 0.0004332272f;
		fConst63 = 2.0f * (0.0004332272f - fConst61);
		fConst64 = fConst49 + 7.6217313f;
		fConst65 = 2.0f * (7.6217313f - fConst49);
		fConst66 = fConst49 + 53.53615f;
		fConst67 = 2.0f * (53.53615f - fConst49);
		fConst68 = 0.7f / fConst53;
		fConst69 = 0.5f * fConst0;
		fConst70 = 0.25f * fConst0;
		fConst71 = 4.0f / fConst0;
		fConst72 = 1.0f - fConst51;
		fConst73 = 1.0f / (fConst51 + 1.0f);
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(0.0f);
		fHslider1 = FAUSTFLOAT(0.0f);
		fHslider2 = FAUSTFLOAT(19.0f);
		fHslider3 = FAUSTFLOAT(81.0f);
		fCheckbox0 = FAUSTFLOAT(0.0f);
		fButton0 = FAUSTFLOAT(0.0f);
		fHslider4 = FAUSTFLOAT(0.03f);
		fHslider5 = FAUSTFLOAT(0.1f);
		fHslider6 = FAUSTFLOAT(0.02f);
		fHslider7 = FAUSTFLOAT(19.0f);
		fHslider8 = FAUSTFLOAT(0.2f);
		fHslider9 = FAUSTFLOAT(92.0f);
		fHslider10 = FAUSTFLOAT(0.666f);
		fHslider11 = FAUSTFLOAT(1.0f);
		fHslider12 = FAUSTFLOAT(0.3f);
		fHslider13 = FAUSTFLOAT(92.0f);
		fHslider14 = FAUSTFLOAT(0.14f);
		fHslider15 = FAUSTFLOAT(0.5f);
		fHslider16 = FAUSTFLOAT(1.0f);
		fHslider17 = FAUSTFLOAT(0.5f);
		fHslider18 = FAUSTFLOAT(6.0f);
		fCheckbox1 = FAUSTFLOAT(0.0f);
		fButton1 = FAUSTFLOAT(0.0f);
		fHslider19 = FAUSTFLOAT(0.02f);
		fHslider20 = FAUSTFLOAT(0.15f);
		fHslider21 = FAUSTFLOAT(-0.79f);
		fHslider22 = FAUSTFLOAT(4e+01f);
		fHslider23 = FAUSTFLOAT(1.0f);
		fHslider24 = FAUSTFLOAT(1.0f);
		fCheckbox2 = FAUSTFLOAT(0.0f);
		fButton2 = FAUSTFLOAT(0.0f);
		fHslider25 = FAUSTFLOAT(0.02f);
		fHslider26 = FAUSTFLOAT(3.0f);
		fHslider27 = FAUSTFLOAT(0.0f);
		fHslider28 = FAUSTFLOAT(38.0f);
	...
	virtual void instanceClear() {
		...
		for (int l127 = 0; l127 < 4096; l127 = l127 + 1) {
			fVec30[l127] = 0.0f;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Synth3");
		ui_interface->addHorizontalSlider("adriftFreq", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("adriftVol", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("bpm", &fHslider3, FAUSTFLOAT(81.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(4e+02f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("fm1vol", &fHslider16, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("fmAC1", &fHslider4, FAUSTFLOAT(0.03f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("fmAM1", &fHslider6, FAUSTFLOAT(0.02f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("fmDp1", &fHslider12, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.0001f));
		ui_interface->addHorizontalSlider("fmEucNo1", &fHslider2, FAUSTFLOAT(19.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(24.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("fmEucNo2", &fHslider7, FAUSTFLOAT(19.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(24.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("fmFreq1", &fHslider13, FAUSTFLOAT(92.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("fmFreq2", &fHslider9, FAUSTFLOAT(92.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(0.01f));
		ui_interface->addCheckButton("fmGateT1", &fCheckbox0);
		ui_interface->addHorizontalSlider("fmMm1", &fHslider10, FAUSTFLOAT(0.666f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0001f));
		ui_interface->addHorizontalSlider("fmModWheel1", &fHslider11, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("fmRC1", &fHslider5, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("fmRM1", &fHslider8, FAUSTFLOAT(0.2f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.01f));
		ui_interface->addButton("fmTrigD1", &fButton0);
		ui_interface->addHorizontalSlider("fmVerb", &fHslider14, FAUSTFLOAT(0.14f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("fmVol", &fHslider15, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("kd1vol", &fHslider23, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("kd2vol", &fHslider29, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("kdA1", &fHslider19, FAUSTFLOAT(0.02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(15.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("kdA2", &fHslider25, FAUSTFLOAT(0.02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(15.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("kdDelta1", &fHslider21, FAUSTFLOAT(-0.79f), FAUSTFLOAT(-0.99f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("kdDelta2", &fHslider27, FAUSTFLOAT(0.0f), FAUSTFLOAT(-0.99f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("kdEucNo1", &fHslider18, FAUSTFLOAT(6.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(24.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("kdEucNo2", &fHslider24, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(24.0f), FAUSTFLOAT(1.0f));
		ui_interface->addCheckButton("kdGateT1", &fCheckbox1);
		ui_interface->addCheckButton("kdGateT2", &fCheckbox2);
		ui_interface->addHorizontalSlider("kdNxtFreq1", &fHslider22, FAUSTFLOAT(4e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("kdNxtFreq2", &fHslider28, FAUSTFLOAT(38.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("kdR1", &fHslider20, FAUSTFLOAT(0.15f), FAUSTFLOAT(0.0f), FAUSTFLOAT(15.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("kdR2", &fHslider26, FAUSTFLOAT(3.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(15.0f), FAUSTFLOAT(0.01f));
		ui_interface->addButton("kdTrig1", &fButton1);
		ui_interface->addButton("kdTrig2", &fButton2);
		ui_interface->addHorizontalSlider("masterVol", &fHslider17, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = fConst16 * (1e+03f * float(fHslider0) + 1.2e+02f);
		float fSlow1 = fConst30 * mydsp_faustpower2_f(float(fHslider1));
		float fSlow2 = float(fHslider2);
		float fSlow3 = fConst31 * float(fHslider3);
		...
		float fSlow12 = 4.4e+02f * std::pow(2.0f, 0.083333336f * (float(fHslider9) + -69.0f));
		float fSlow13 = fConst16 * float(fHslider10);
		float fSlow14 = fConst16 * float(fHslider11);
		float fSlow15 = fConst16 * float(fHslider12);
		float fSlow16 = 4.4e+02f * std::pow(2.0f, 0.083333336f * (float(fHslider13) + -69.0f));
		float fSlow17 = fConst16 * float(fHslider14);
		float fSlow18 = fConst16 * float(fHslider15);
		float fSlow19 = float(fHslider16);
		float fSlow20 = fConst16 * float(fHslider17);
		float fSlow21 = float(fHslider18);
		float fSlow22 = float(fCheckbox1);
		float fSlow23 = float(fButton1);
		float fSlow24 = float(fHslider19);
		float fSlow25 = float(fHslider20);
		float fSlow26 = fSlow25 + fSlow24;
		float fSlow27 = float(fHslider21);
		float fSlow28 = 4.4e+02f * std::pow(2.0f, 0.083333336f * (float(fHslider22) + -69.0f));
		float fSlow29 = fConst71 * float(fHslider23);
		float fSlow30 = float(fHslider24);
		float fSlow31 = float(fCheckbox2);
		float fSlow32 = float(fButton2);
		float fSlow33 = float(fHslider25);
		float fSlow34 = float(fHslider26);
		float fSlow35 = fSlow34 + fSlow33;
		float fSlow36 = float(fHslider27);
		float fSlow37 = 4.4e+02f * std::pow(2.0f, 0.083333336f * (float(fHslider28) + -69.0f));
		float fSlow38 = fConst28 * float(fHslider29);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fRec5[0] = fSlow0 + fConst17 * fRec5[1];
			float fTemp0 = std::tan(fConst18 * fRec5[0]);
			float fTemp1 = 1.0f / fTemp0;
			float fTemp2 = (fTemp1 + 0.16840488f) / fTemp0 + 1.0693583f;
			float fTemp3 = mydsp_faustpower2_f(fTemp0);
			float fTemp4 = 1.0f / fTemp3;
			float fTemp5 = fTemp4 + 53.53615f;
			float fTemp6 = (fTemp1 + 0.51247865f) / fTemp0 + 0.6896214f;
			float fTemp7 = fTemp4 + 7.6217313f;
			float fTemp8 = (fTemp1 + 0.78241307f) / fTemp0 + 0.2452915f;
			float fTemp9 = 0.0001f / fTemp3;
			float fTemp10 = fTemp9 + 0.0004332272f;
			iRec9[0] = 1103515245 * iRec9[1] + 12345;
			fRec8[0] = 4.656613e-11f * float(iRec9[0]) - (fRec8[2] * ((fTemp1 + -0.78241307f) / fTemp0 + 0.2452915f) + 2.0f * fRec8[1] * (0.2452915f - fTemp4)) / fTemp8;
			fRec7[0] = (fRec8[0] * fTemp10 + 2.0f * fRec8[1] * (0.0004332272f - fTemp9) + fRec8[2] * fTemp10) / fTemp8 - (fRec7[2] * ((fTemp1 + -0.51247865f) / fTemp0 + 0.6896214f) + 2.0f * fRec7[1] * (0.6896214f - fTemp4)) / fTemp6;
			fRec6[0] = (fRec7[0] * fTemp7 + 2.0f * fRec7[1] * (7.6217313f - fTemp4) + fRec7[2] * fTemp7) / fTemp6 - (fRec6[2] * ((fTemp1 + -0.16840488f) / fTemp0 + 1.0693583f) + 2.0f * fRec6[1] * (1.0693583f - fTemp4)) / fTemp2;
			fRec4[0] = (fRec6[0] * fTemp5 + 2.0f * fRec6[1] * (53.53615f - fTemp4) + fRec6[2] * fTemp5) / fTemp2 - fConst15 * (fConst14 * fRec4[2] + fConst13 * fRec4[1]);
			fRec3[0] = fConst15 * (fConst20 * fRec4[0] + fConst21 * fRec4[1] + fConst20 * fRec4[2]) - fConst12 * (fConst11 * fRec3[2] + fConst10 * fRec3[1]);
			fRec2[0] = fConst12 * (fConst23 * fRec3[0] + fConst24 * fRec3[1] + fConst23 * fRec3[2]) - fConst9 * (fConst8 * fRec2[2] + fConst6 * fRec2[1]);
			fRec10[0] = fSlow1 + fConst29 * fRec10[1];
			fRec18[0] = fSlow3 + (fRec18[1] - std::floor(fSlow3 + fRec18[1]));
			float fTemp11 = float(int(48.0f * fRec18[0]) + 1);
			int iTemp12 = std::fmod(fSlow2 * fTemp11, 48.0f) < fSlow2;
			iVec2[0] = iTemp12;
			iRec17[0] = (iRec17[1] + (iRec17[1] > 0)) * (iTemp12 <= iVec2[1]) + (iTemp12 > iVec2[1]);
			float fTemp13 = float(iRec17[0]);
			float fTemp14 = float(1 - (fRec15[1] > 0.0f)) * (fSlow5 + fSlow4 * std::max<float>(0.0f, std::min<float>(fTemp13, fConst32 * (1.0f - fTemp13) + 1.0f)));
			fVec3[0] = fTemp14;
			int iTemp15 = int(fTemp14);
			iRec16[0] = ((iTemp15) ? 0 : iRec16[1]);
			float fTemp16 = std::max<float>(1.0f, fConst0 * float(iRec16[0]));
			iRec19[0] = (iRec19[1] + (iRec19[1] > 0)) * (fTemp14 <= fVec3[1]) + (fTemp14 > fVec3[1]);
			float fTemp17 = float(iRec19[0]);
			fRec20[0] = ((iTemp15) ? fSlow8 : fRec20[1]);
			fRec15[0] = std::max<float>(0.0f, std::min<float>(fTemp17 / fTemp16, (fTemp16 - fTemp17) / std::max<float>(1.0f, fConst0 * fRec20[0]) + 1.0f));
			iRec14[0] = (iRec14[1] + (iRec14[1] > 0)) * (fRec15[0] <= fRec15[1]) + (fRec15[0] > fRec15[1]);
			float fTemp18 = float(iRec14[0]);
			float fTemp19 = std::max<float>(0.0f, std::min<float>(fTemp18, fConst32 * (1.0f - fTemp18) + 1.0f));
			fVec4[0] = fTemp19;
			int iTemp20 = int(fTemp19);
			fRec13[0] = ((iTemp20) ? fSlow9 : fRec13[1]);
			float fTemp21 = std::max<float>(1.0f, fConst0 * fRec13[0]);
			int iTemp22 = std::fmod(fSlow10 * fTemp11, 48.0f) < fSlow10;
			iVec5[0] = iTemp22;
			iRec25[0] = (iRec25[1] + (iRec25[1] > 0)) * (iTemp22 <= iVec5[1]) + (iTemp22 > iVec5[1]);
			float fTemp23 = float(iRec25[0]);
			float fTemp24 = float(1 - (fRec23[1] > 0.0f)) * (fSlow5 + fSlow4 * std::max<float>(0.0f, std::min<float>(fTemp23, fConst32 * (1.0f - fTemp23) + 1.0f)));
			fVec6[0] = fTemp24;
			int iTemp25 = int(fTemp24);
			iRec24[0] = ((iTemp25) ? 0 : iRec24[1]);
			float fTemp26 = std::max<float>(1.0f, fConst0 * float(iRec24[0]));
			iRec26[0] = (iRec26[1] + (iRec26[1] > 0)) * (fTemp24 <= fVec6[1]) + (fTemp24 > fVec6[1]);
			float fTemp27 = float(iRec26[0]);
			fRec27[0] = ((iTemp25) ? fSlow8 : fRec27[1]);
			fRec23[0] = std::max<float>(0.0f, std::min<float>(fTemp27 / fTemp26, (fTemp26 - fTemp27) / std::max<float>(1.0f, fConst0 * fRec27[0]) + 1.0f));
			iRec22[0] = (iRec22[1] + (iRec22[1] > 0)) * (fRec23[0] <= fRec23[1]) + (fRec23[0] > fRec23[1]);
			float fTemp28 = float(iRec22[0]);
			float fTemp29 = std::max<float>(0.0f, std::min<float>(fTemp28, fConst32 * (1.0f - fTemp28) + 1.0f));
			fVec7[0] = fTemp29;
			iRec21[0] = (iRec21[1] + (iRec21[1] > 0)) * (fTemp29 <= fVec7[1]) + (fTemp29 > fVec7[1]);
			float fTemp30 = float(iRec21[0]);
			fRec28[0] = ((iTemp20) ? fSlow11 : fRec28[1]);
			float fTemp31 = std::max<float>(1.0f, fConst0 * fRec28[0]);
			fRec30[0] = ((int(fTemp29)) ? fSlow12 : fRec30[1]);
			fRec31[0] = fSlow13 + fConst17 * fRec31[1];
			float fTemp32 = fRec29[1] + fConst28 * fRec31[0] * fRec30[0];
			fRec29[0] = fTemp32 - std::floor(fTemp32);
			fRec32[0] = fSlow14 + fConst17 * fRec32[1];
			fRec33[0] = fSlow15 + fConst17 * fRec33[1];
			float fTemp33 = fRec33[0] * fRec32[0];
			float fTemp34 = fRec12[1] + fConst28 * fRec30[0] * (fTemp33 * ftbl0mydspSIG0[int(32768.0f * fRec29[0])] * std::max<float>(0.0f, std::min<float>(fTemp30 / fTemp21, (fTemp21 - fTemp30) / fTemp31 + 1.0f)) + 1.0f);
			fRec12[0] = fTemp34 - std::floor(fTemp34);
			float fTemp35 = fTemp29 * float(1 - (fRec34[1] > 0.0f));
			fVec8[0] = fTemp35;
			int iTemp36 = int(fTemp35);
			fRec36[0] = ((iTemp20) ? fSlow6 : fRec36[1]);
			fRec35[0] = ((iTemp36) ? fRec36[0] : fRec35[1]);
			float fTemp37 = std::max<float>(1.0f, fConst0 * fRec35[0]);
			iRec37[0] = (iRec37[1] + (iRec37[1] > 0)) * (fTemp35 <= fVec8[1]) + (fTemp35 > fVec8[1]);
			float fTemp38 = float(iRec37[0]);
			fRec39[0] = ((iTemp20) ? fSlow7 : fRec39[1]);
			fRec38[0] = ((iTemp36) ? fRec39[0] : fRec38[1]);
			fRec34[0] = std::max<float>(0.0f, std::min<float>(fTemp38 / fTemp37, (fTemp37 - fTemp38) / std::max<float>(1.0f, fConst0 * fRec38[0]) + 1.0f));
			iRec41[0] = (iRec41[1] + (iRec41[1] > 0)) * (fTemp19 <= fVec4[1]) + (fTemp19 > fVec4[1]);
			float fTemp39 = float(iRec41[0]);
			fRec43[0] = ((iTemp20) ? fSlow16 : fRec43[1]);
			float fTemp40 = fRec42[1] + fConst28 * fRec43[0] * fRec31[0];
			fRec42[0] = fTemp40 - std::floor(fTemp40);
			float fTemp41 = fRec40[1] + fConst28 * fRec43[0] * (fTemp33 * ftbl0mydspSIG0[int(32768.0f * fRec42[0])] * std::max<float>(0.0f, std::min<float>(fTemp39 / fTemp21, (fTemp21 - fTemp39) / fTemp31 + 1.0f)) + 1.0f);
			fRec40[0] = fTemp41 - std::floor(fTemp41);
			float fTemp42 = fTemp19 * float(1 - (fRec44[1] > 0.0f));
			fVec9[0] = fTemp42;
			int iTemp43 = int(fTemp42);
			fRec45[0] = ((iTemp43) ? fRec36[0] : fRec45[1]);
			float fTemp44 = std::max<float>(1.0f, fConst0 * fRec45[0]);
			iRec46[0] = (iRec46[1] + (iRec46[1] > 0)) * (fTemp42 <= fVec9[1]) + (fTemp42 > fVec9[1]);
			float fTemp45 = float(iRec46[0]);
			fRec47[0] = ((iTemp43) ? fRec39[0] : fRec47[1]);
			fRec44[0] = std::max<float>(0.0f, std::min<float>(fTemp45 / fTemp44, (fTemp44 - fTemp45) / std::max<float>(1.0f, fConst0 * fRec47[0]) + 1.0f));
			float fTemp46 = fRec44[0] * ftbl0mydspSIG0[int(32768.0f * fRec40[0])] + fRec34[0] * ftbl0mydspSIG0[int(32768.0f * fRec12[0])];
			fRec48[0] = fSlow17 + fConst17 * fRec48[1];
			fRec49[0] = fSlow18 + fConst17 * fRec49[1];
			fRec59[0] = 0.8f * fRec59[1] + 0.2f * fRec58[1];
			float fTemp47 = fSlow19 * fRec49[0] * fRec48[0] * fTemp46;
			fVec10[IOTA0 & 8191] = fTemp47 + 0.88f * fRec59[0];
			fRec58[0] = fVec10[(IOTA0 - iConst33) & 8191];
			fRec61[0] = 0.8f * fRec61[1] + 0.2f * fRec60[1];
			fVec11[IOTA0 & 8191] = fTemp47 + 0.88f * fRec61[0];
			fRec60[0] = fVec11[(IOTA0 - iConst34) & 8191];
			fRec63[0] = 0.8f * fRec63[1] + 0.2f * fRec62[1];
			fVec12[IOTA0 & 8191] = fTemp47 + 0.88f * fRec63[0];
			fRec62[0] = fVec12[(IOTA0 - iConst35) & 8191];
			fRec65[0] = 0.8f * fRec65[1] + 0.2f * fRec64[1];
			fVec13[IOTA0 & 8191] = fTemp47 + 0.88f * fRec65[0];
			fRec64[0] = fVec13[(IOTA0 - iConst36) & 8191];
			fRec67[0] = 0.8f * fRec67[1] + 0.2f * fRec66[1];
			fVec14[IOTA0 & 8191] = fTemp47 + 0.88f * fRec67[0];
			fRec66[0] = fVec14[(IOTA0 - iConst37) & 8191];
			fRec69[0] = 0.8f * fRec69[1] + 0.2f * fRec68[1];
			fVec15[IOTA0 & 8191] = fTemp47 + 0.88f * fRec69[0];
			fRec68[0] = fVec15[(IOTA0 - iConst38) & 8191];
			fRec71[0] = 0.8f * fRec71[1] + 0.2f * fRec70[1];
			fVec16[IOTA0 & 8191] = fTemp47 + 0.88f * fRec71[0];
			fRec70[0] = fVec16[(IOTA0 - iConst39) & 8191];
			fRec73[0] = 0.8f * fRec73[1] + 0.2f * fRec72[1];
			fVec17[IOTA0 & 8191] = 0.88f * fRec73[0] + fTemp47;
			fRec72[0] = fVec17[(IOTA0 - iConst40) & 8191];
			float fTemp48 = fRec72[0] + fRec70[0] + fRec68[0] + fRec66[0] + fRec64[0] + fRec62[0] + fRec60[0] + fRec58[0] + 0.88f * fRec56[1];
			fVec18[IOTA0 & 2047] = fTemp48;
			fRec56[0] = fVec18[(IOTA0 - iConst41) & 2047];
			float fRec57 = 0.0f - 0.88f * fTemp48;
			float fTemp49 = fRec56[1] + fRec57 + 0.88f * fRec54[1];
			fVec19[IOTA0 & 2047] = fTemp49;
			fRec54[0] = fVec19[(IOTA0 - iConst42) & 2047];
			float fRec55 = 0.0f - 0.88f * fTemp49;
			float fTemp50 = fRec54[1] + fRec55 + 0.88f * fRec52[1];
			fVec20[IOTA0 & 2047] = fTemp50;
			fRec52[0] = fVec20[(IOTA0 - iConst43) & 2047];
			float fRec53 = 0.0f - 0.88f * fTemp50;
			float fTemp51 = fRec52[1] + fRec53 + 0.88f * fRec50[1];
			fVec21[IOTA0 & 1023] = fTemp51;
			fRec50[0] = fVec21[(IOTA0 - iConst44) & 1023];
			float fRec51 = 0.0f - 0.88f * fTemp51;
			float fTemp52 = fRec50[1] + fRec51 + fSlow19 * fRec49[0] * (1.0f - fRec48[0]) * fTemp46 + fConst9 * fRec10[0] * (fConst26 * fRec2[0] + fConst27 * fRec2[1] + fConst26 * fRec2[2]);
			fRec1[0] = fConst45 * std::fabs(fTemp52) + fConst2 * fRec1[1];
			fRec0[0] = fConst46 * (0.0f - 0.875f * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec1[0])) + 8.0f, 0.0f)) + fConst1 * fRec0[1];
			float fTemp53 = std::pow(1e+01f, 0.05f * fRec0[0]);
			fRec74[0] = fSlow20 + fConst17 * fRec74[1];
			output0[i0] = FAUSTFLOAT(fRec74[0] * fTemp52 * fTemp53);
			fRec81[0] = fTemp52 * fTemp53 - fConst60 * (fConst59 * fRec81[2] + fConst58 * fRec81[1]);
			fRec80[0] = fConst60 * (fConst62 * fRec81[0] + fConst63 * fRec81[1] + fConst62 * fRec81[2]) - fConst57 * (fConst56 * fRec80[2] + fConst55 * fRec80[1]);
			fRec79[0] = fConst57 * (fConst64 * fRec80[0] + fConst65 * fRec80[1] + fConst64 * fRec80[2]) - fConst54 * (fConst52 * fRec79[2] + fConst50 * fRec79[1]);
			int iTemp54 = std::fmod(fSlow21 * fTemp11, 48.0f) < fSlow21;
			iVec22[0] = iTemp54;
			iRec86[0] = (iRec86[1] + (iRec86[1] > 0)) * (iTemp54 <= iVec22[1]) + (iTemp54 > iVec22[1]);
			float fTemp55 = float(iRec86[0]);
			float fTemp56 = fSlow23 + fSlow22 * std::max<float>(0.0f, std::min<float>(fTemp55, fConst32 * (1.0f - fTemp55) + 1.0f));
			float fTemp57 = float(1 - (fRec84[1] > 0.0f)) * fTemp56;
			fVec23[0] = fTemp57;
			int iTemp58 = int(fTemp57);
			fRec85[0] = ((iTemp58) ? fSlow26 : fRec85[1]);
			float fTemp59 = std::max<float>(1.0f, fConst0 * fRec85[0]);
			iRec87[0] = (iRec87[1] + (iRec87[1] > 0)) * (fTemp57 <= fVec23[1]) + (fTemp57 > fVec23[1]);
			float fTemp60 = float(iRec87[0]);
			iRec88[0] = ((iTemp58) ? 0 : iRec88[1]);
			fRec84[0] = std::max<float>(0.0f, std::min<float>(fTemp60 / fTemp59, (fTemp59 - fTemp60) / std::max<float>(1.0f, fConst0 * float(iRec88[0])) + 1.0f));
			iRec83[0] = (iRec83[1] + (iRec83[1] > 0)) * (fRec84[0] <= fRec84[1]) + (fRec84[0] > fRec84[1]);
			float fTemp61 = float(iRec83[0]);
			int iTemp62 = int(1.0f - std::max<float>(0.0f, std::min<float>(fTemp61, fConst32 * (1.0f - fTemp61) + 1.0f)));
			fRec82[0] = ((iTemp62) ? fSlow27 : fRec82[1]);
			float fTemp63 = fRec84[0] * fRec82[0] + 1.0f;
			float fTemp64 = fTemp56 * float(1 - (fRec89[1] > 0.0f));
			fVec24[0] = fTemp64;
			int iTemp65 = int(fTemp64);
			fRec90[0] = ((iTemp65) ? fSlow24 : fRec90[1]);
			float fTemp66 = std::max<float>(1.0f, fConst0 * fRec90[0]);
			iRec91[0] = (iRec91[1] + (iRec91[1] > 0)) * (fTemp64 <= fVec24[1]) + (fTemp64 > fVec24[1]);
			float fTemp67 = float(iRec91[0]);
			fRec92[0] = ((iTemp65) ? fSlow25 : fRec92[1]);
			fRec89[0] = std::max<float>(0.0f, std::min<float>(fTemp67 / fTemp66, (fTemp66 - fTemp67) / std::max<float>(1.0f, fConst0 * fRec92[0]) + 1.0f));
			fRec94[0] = ((iTemp62) ? fSlow28 : fRec94[1]);
			float fTemp68 = std::max<float>(fRec94[0] * fTemp63, 23.44895f);
			float fTemp69 = std::max<float>(2e+01f, std::fabs(fTemp68));
			float fTemp70 = fRec95[1] + fConst28 * fTemp69;
			fRec95[0] = fTemp70 - std::floor(fTemp70);
			float fTemp71 = mydsp_faustpower2_f(2.0f * fRec95[0] + -1.0f);
			fVec25[0] = fTemp71;
			float fTemp72 = float(iVec0[1]);
			float fTemp73 = fTemp72 * (fTemp71 - fVec25[1]) / fTemp69;
			fVec26[IOTA0 & 4095] = fTemp73;
			float fTemp74 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst69 / fTemp68));
			int iTemp75 = int(fTemp74);
			float fTemp76 = std::floor(fTemp74);
			fRec93[0] = 0.999f * fRec93[1] + fConst70 * (fTemp73 - fVec26[(IOTA0 - iTemp75) & 4095] * (fTemp76 + (1.0f - fTemp74)) - (fTemp74 - fTemp76) * fVec26[(IOTA0 - (iTemp75 + 1)) & 4095]);
			float fTemp77 = fSlow29 * fRec94[0] * fRec93[0] * fRec89[0] * fTemp63;
			int iTemp78 = std::fmod(fSlow30 * fTemp11, 48.0f) < fSlow30;
			iVec27[0] = iTemp78;
			iRec102[0] = (iRec102[1] + (iRec102[1] > 0)) * (iTemp78 <= iVec27[1]) + (iTemp78 > iVec27[1]);
			float fTemp79 = float(iRec102[0]);
			float fTemp80 = fSlow32 + fSlow31 * std::max<float>(0.0f, std::min<float>(fTemp79, fConst32 * (1.0f - fTemp79) + 1.0f));
			float fTemp81 = float(1 - (fRec100[1] > 0.0f)) * fTemp80;
			fVec28[0] = fTemp81;
			int iTemp82 = int(fTemp81);
			fRec101[0] = ((iTemp82) ? fSlow35 : fRec101[1]);
			float fTemp83 = std::max<float>(1.0f, fConst0 * fRec101[0]);
			iRec103[0] = (iRec103[1] + (iRec103[1] > 0)) * (fTemp81 <= fVec28[1]) + (fTemp81 > fVec28[1]);
			float fTemp84 = float(iRec103[0]);
			iRec104[0] = ((iTemp82) ? 0 : iRec104[1]);
			fRec100[0] = std::max<float>(0.0f, std::min<float>(fTemp84 / fTemp83, (fTemp83 - fTemp84) / std::max<float>(1.0f, fConst0 * float(iRec104[0])) + 1.0f));
			iRec99[0] = (iRec99[1] + (iRec99[1] > 0)) * (fRec100[0] <= fRec100[1]) + (fRec100[0] > fRec100[1]);
			float fTemp85 = float(iRec99[0]);
			int iTemp86 = int(1.0f - std::max<float>(0.0f, std::min<float>(fTemp85, fConst32 * (1.0f - fTemp85) + 1.0f)));
			fRec98[0] = ((iTemp86) ? fSlow36 : fRec98[1]);
			float fTemp87 = fRec100[0] * fRec98[0] + 1.0f;
			fRec105[0] = ((iTemp86) ? fSlow37 : fRec105[1]);
			float fTemp88 = fRec105[0] * fTemp87;
			float fTemp89 = std::max<float>(fTemp88, 23.44895f);
			float fTemp90 = std::max<float>(2e+01f, std::fabs(fTemp89));
			float fTemp91 = fRec106[1] + fConst28 * fTemp90;
			fRec106[0] = fTemp91 - std::floor(fTemp91);
			float fTemp92 = mydsp_faustpower2_f(2.0f * fRec106[0] + -1.0f);
			fVec29[0] = fTemp92;
			float fTemp93 = fTemp72 * (fTemp92 - fVec29[1]) / fTemp90;
			fVec30[IOTA0 & 4095] = fTemp93;
			float fTemp94 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst69 / fTemp89));
			int iTemp95 = int(fTemp94);
			float fTemp96 = std::floor(fTemp94);
			fRec97[0] = 0.999f * fRec97[1] + fConst70 * (fTemp93 - fVec30[(IOTA0 - iTemp95) & 4095] * (fTemp96 + (1.0f - fTemp94)) - (fTemp94 - fTemp96) * fVec30[(IOTA0 - (iTemp95 + 1)) & 4095]);
			float fTemp97 = std::max<float>(2.0f * fTemp88, 23.44895f);
			float fTemp98 = std::max<float>(2e+01f, std::fabs(fTemp97));
			float fTemp99 = fRec108[1] + fConst28 * fTemp98;
			fRec108[0] = fTemp99 - std::floor(fTemp99);
			float fTemp100 = mydsp_faustpower2_f(2.0f * fRec108[0] + -1.0f);
			fVec31[0] = fTemp100;
			float fTemp101 = fTemp72 * (fTemp100 - fVec31[1]) / fTemp98;
			fVec32[IOTA0 & 4095] = fTemp101;
			float fTemp102 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst69 / fTemp97));
			int iTemp103 = int(fTemp102);
			float fTemp104 = std::floor(fTemp102);
			fRec107[0] = 0.999f * fRec107[1] + fConst70 * (fTemp101 - fVec32[(IOTA0 - iTemp103) & 4095] * (fTemp104 + (1.0f - fTemp102)) - (fTemp102 - fTemp104) * fVec32[(IOTA0 - (iTemp103 + 1)) & 4095]);
			float fTemp105 = fTemp80 * float(1 - (fRec109[1] > 0.0f));
			fVec33[0] = fTemp105;
			int iTemp106 = int(fTemp105);
			fRec110[0] = ((iTemp106) ? fSlow33 : fRec110[1]);
			float fTemp107 = std::max<float>(1.0f, fConst0 * fRec110[0]);
			iRec111[0] = (iRec111[1] + (iRec111[1] > 0)) * (fTemp105 <= fVec33[1]) + (fTemp105 > fVec33[1]);
			float fTemp108 = float(iRec111[0]);
			fRec112[0] = ((iTemp106) ? fSlow34 : fRec112[1]);
			fRec109[0] = std::max<float>(0.0f, std::min<float>(fTemp108 / fTemp107, (fTemp107 - fTemp108) / std::max<float>(1.0f, fConst0 * fRec112[0]) + 1.0f));
			float fTemp109 = fSlow38 * fRec105[0] * fRec109[0] * fTemp87 * (8.0f * fRec107[0] + 4.0f * fRec97[0]);
			fVec34[0] = fTemp109;
			fRec96[0] = 0.0f - fConst73 * (fConst72 * fRec96[1] - (fTemp109 + fVec34[1]));
			float fTemp110 = fRec96[0] + fTemp77 + fConst68 * (fConst66 * fRec79[0] + fConst67 * fRec79[1] + fConst66 * fRec79[2]);
			fRec78[0] = fConst45 * std::fabs(fTemp110) + fConst2 * fRec78[1];
			fRec77[0] = fConst46 * (0.0f - 0.875f * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec78[0])) + 15.0f, 0.0f)) + fConst1 * fRec77[1];
			float fTemp111 = fTemp77 + fTemp110 * std::pow(1e+01f, 0.05f * fRec77[0]);
			fRec76[0] = fConst45 * std::fabs(fTemp111) + fConst2 * fRec76[1];
			fRec75[0] = fConst46 * (0.0f - 0.875f * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec76[0])) + 8.0f, 0.0f)) + fConst1 * fRec75[1];
			output1[i0] = FAUSTFLOAT(fRec74[0] * fTemp111 * std::pow(1e+01f, 0.05f * fRec75[0]));
			iVec0[1] = iVec0[0];
			fRec5[1] = fRec5[0];
			iRec9[1] = iRec9[0];
			fRec8[2] = fRec8[1];
	...
	#define FAUST_FILE_NAME "Synth3.dsp"
	...
	#define FAUST_ACTIVES 36
	#define FAUST_PASSIVES 0

	FAUST_ADDHORIZONTALSLIDER("adriftFreq", fHslider0, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("adriftVol", fHslider1, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("bpm", fHslider3, 81.0f, 1.0f, 4e+02f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("fm1vol", fHslider16, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("fmAC1", fHslider4, 0.03f, 0.001f, 1e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("fmAM1", fHslider6, 0.02f, 0.001f, 1e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("fmDp1", fHslider12, 0.3f, 0.0f, 1e+01f, 0.0001f);
	FAUST_ADDHORIZONTALSLIDER("fmEucNo1", fHslider2, 19.0f, 0.0f, 24.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("fmEucNo2", fHslider7, 19.0f, 0.0f, 24.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("fmFreq1", fHslider13, 92.0f, 0.0f, 127.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("fmFreq2", fHslider9, 92.0f, 0.0f, 127.0f, 0.01f);
	FAUST_ADDCHECKBOX("fmGateT1", fCheckbox0);
	FAUST_ADDHORIZONTALSLIDER("fmMm1", fHslider10, 0.666f, 0.0f, 1e+02f, 0.0001f);
	FAUST_ADDHORIZONTALSLIDER("fmModWheel1", fHslider11, 1.0f, 0.1f, 1e+02f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("fmRC1", fHslider5, 0.1f, 0.001f, 1e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("fmRM1", fHslider8, 0.2f, 0.001f, 1e+01f, 0.01f);
	FAUST_ADDBUTTON("fmTrigD1", fButton0);
	FAUST_ADDHORIZONTALSLIDER("fmVerb", fHslider14, 0.14f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("fmVol", fHslider15, 0.5f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("kd1vol", fHslider23, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("kd2vol", fHslider29, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("kdA1", fHslider19, 0.02f, 0.0f, 15.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("kdA2", fHslider25, 0.02f, 0.0f, 15.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("kdDelta1", fHslider21, -0.79f, -0.99f, 5.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("kdDelta2", fHslider27, 0.0f, -0.99f, 5.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("kdEucNo1", fHslider18, 6.0f, 0.0f, 24.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("kdEucNo2", fHslider24, 1.0f, 0.0f, 24.0f, 1.0f);
	FAUST_ADDCHECKBOX("kdGateT1", fCheckbox1);
	FAUST_ADDCHECKBOX("kdGateT2", fCheckbox2);
	FAUST_ADDHORIZONTALSLIDER("kdNxtFreq1", fHslider22, 4e+01f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("kdNxtFreq2", fHslider28, 38.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("kdR1", fHslider20, 0.15f, 0.0f, 15.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("kdR2", fHslider26, 3.0f, 0.0f, 15.0f, 0.01f);
	FAUST_ADDBUTTON("kdTrig1", fButton1);
	FAUST_ADDBUTTON("kdTrig2", fButton2);
	FAUST_ADDHORIZONTALSLIDER("masterVol", fHslider17, 0.5f, 0.0f, 1.0f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, adriftFreq, "adriftFreq", fHslider0, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, adriftVol, "adriftVol", fHslider1, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, bpm, "bpm", fHslider3, 81.0f, 1.0f, 4e+02f, 1.0f) \
		p(HORIZONTALSLIDER, fm1vol, "fm1vol", fHslider16, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, fmAC1, "fmAC1", fHslider4, 0.03f, 0.001f, 1e+01f, 0.01f) \
		p(HORIZONTALSLIDER, fmAM1, "fmAM1", fHslider6, 0.02f, 0.001f, 1e+01f, 0.01f) \
		p(HORIZONTALSLIDER, fmDp1, "fmDp1", fHslider12, 0.3f, 0.0f, 1e+01f, 0.0001f) \
		p(HORIZONTALSLIDER, fmEucNo1, "fmEucNo1", fHslider2, 19.0f, 0.0f, 24.0f, 1.0f) \
		p(HORIZONTALSLIDER, fmEucNo2, "fmEucNo2", fHslider7, 19.0f, 0.0f, 24.0f, 1.0f) \
		p(HORIZONTALSLIDER, fmFreq1, "fmFreq1", fHslider13, 92.0f, 0.0f, 127.0f, 0.01f) \
		p(HORIZONTALSLIDER, fmFreq2, "fmFreq2", fHslider9, 92.0f, 0.0f, 127.0f, 0.01f) \
		p(CHECKBOX, fmGateT1, "fmGateT1", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, fmMm1, "fmMm1", fHslider10, 0.666f, 0.0f, 1e+02f, 0.0001f) \
		p(HORIZONTALSLIDER, fmModWheel1, "fmModWheel1", fHslider11, 1.0f, 0.1f, 1e+02f, 0.001f) \
		p(HORIZONTALSLIDER, fmRC1, "fmRC1", fHslider5, 0.1f, 0.001f, 1e+01f, 0.01f) \
		p(HORIZONTALSLIDER, fmRM1, "fmRM1", fHslider8, 0.2f, 0.001f, 1e+01f, 0.01f) \
		p(BUTTON, fmTrigD1, "fmTrigD1", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, fmVerb, "fmVerb", fHslider14, 0.14f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, fmVol, "fmVol", fHslider15, 0.5f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, kd1vol, "kd1vol", fHslider23, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, kd2vol, "kd2vol", fHslider29, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, kdA1, "kdA1", fHslider19, 0.02f, 0.0f, 15.0f, 0.01f) \
		p(HORIZONTALSLIDER, kdA2, "kdA2", fHslider25, 0.02f, 0.0f, 15.0f, 0.01f) \
		p(HORIZONTALSLIDER, kdDelta1, "kdDelta1", fHslider21, -0.79f, -0.99f, 5.0f, 0.001f) \
		p(HORIZONTALSLIDER, kdDelta2, "kdDelta2", fHslider27, 0.0f, -0.99f, 5.0f, 0.001f) \
		p(HORIZONTALSLIDER, kdEucNo1, "kdEucNo1", fHslider18, 6.0f, 0.0f, 24.0f, 1.0f) \
		p(HORIZONTALSLIDER, kdEucNo2, "kdEucNo2", fHslider24, 1.0f, 0.0f, 24.0f, 1.0f) \
		p(CHECKBOX, kdGateT1, "kdGateT1", fCheckbox1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, kdGateT2, "kdGateT2", fCheckbox2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, kdNxtFreq1, "kdNxtFreq1", fHslider22, 4e+01f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, kdNxtFreq2, "kdNxtFreq2", fHslider28, 38.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, kdR1, "kdR1", fHslider20, 0.15f, 0.0f, 15.0f, 0.01f) \
		p(HORIZONTALSLIDER, kdR2, "kdR2", fHslider26, 3.0f, 0.0f, 15.0f, 0.01f) \
		p(BUTTON, kdTrig1, "kdTrig1", fButton1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, kdTrig2, "kdTrig2", fButton2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, masterVol, "masterVol", fHslider17, 0.5f, 0.0f, 1.0f, 0.001f) \
...
Synth3::Synth3() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void Synth3::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void Synth3::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float Synth3::getParamValue(const std::string& path)
{
